...
class libxdaqnp(ConanFile):
    ...
    def requirements(self):
        ...
        # transitive_headers=True: consumers of libxdaqnp get xdaq's CMakeDeps-generated
        # cmake config, which libxdaqnp-config.cmake needs for find_dependency(xdaq).
        # Also required because xdaq_device is a PUBLIC link dep of xdaq_npapi.
        self.requires("libxdaq/0.10.0", transitive_headers=True)
    ...
    def package(self):
        ...
        copy(self, "*", local_include_folder,
             Path(self.package_folder, "include"))
